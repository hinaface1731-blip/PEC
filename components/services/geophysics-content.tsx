...
const data = {
  ...
  reverse: true,
  methods: [
    { ru: 'Аудиомагнитотеллурические зондирования (АМТЗ)', en: 'Audio-magnetotelluric sounding (AMT)' },
    { ru: 'Метод переходных процессов (ТЭМ/ЗСБ)', en: 'Transient electromagnetic method (TEM)' },
    { ru: 'Магниторазведка (пешеходная, аэро)', en: 'Magnetic survey (ground, airborne)' },
    { ru: 'Гравиразведка', en: 'Gravity survey' },
    { ru: 'Вертикальное электрическое зондирование (ВЭЗ)', en: 'Vertical electrical sounding (VES)' },
    { ru: 'БИЭП', en: 'CDP seismic survey' },
    { ru: 'Электротомография', en: 'Electrical resistivity tomography' },
    { ru: 'Метод вызванной поляризации (ВП)', en: 'Induced polarization method (IP)' },
    { ru: 'Метод естественного электрического поля', en: 'Self-potential method' },
    { ru: 'Каротаж скважин (КС, ПС, ГК, РК)', en: 'Well logging (resistivity, SP, GR, density)' },
    { ru: 'Резистивиметрия', en: 'Resistivity logging' },
  ],
